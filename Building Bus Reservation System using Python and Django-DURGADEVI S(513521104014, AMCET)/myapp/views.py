...
def home(request):
    if request.user.is_authenticated:
        ...
        return render(request, 'myapp/signinpage.html')
...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        if bus_list:
            return render(request, 'myapp/bookingform.html', locals())
        else:
            context['data'] = request.POST
            context["error"] = "No bus is available for entered Route and Date"
    ...
    if request.method == 'POST':
        ...
        if bus:
            if bus.rem > int(seats_r):
                ...
                # book.save()
                return render(request, 'myapp/bookingconformationdetails.html', locals())
            else:
...
def seebookings(request,new={}):
    ...
    if book_list:
        return render(request, 'myapp/bookinglist.html', locals())
    else:
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            login(request, user)
            return render(request, 'myapp/thankforregistration.html')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'myapp/registrationpage.html', context)
    else:
        return render(request, 'myapp/registrationpage.html', context)
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            return render(request, 'myapp/successfullogin.html', context)
            # return HttpResponseRedirect('success')
        else:
            context["error"] = "Provide valid credentials"
            return render(request, 'myapp/signinpage.html', context)
    else:
        context["error"] = "OOPS!! You are not logged in"
        return render(request, 'myapp/signinpage.html', context)
...
def signout(request):
    context = {}
    logout(request)
    context['error'] = "HEYY!! You have been logged out"
    return render(request, 'myapp/signinpage.html', context)
